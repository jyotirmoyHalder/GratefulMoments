...
enum BadgeDetails: Int, Codable, CaseIterable {
    ...
    var requirements: String {
        ...
        case .perfectTen:
            return "Record at least 10 moments, collecting all the otehr badges along the way."
        }
    }
    ...
    var congratulatoryMessage: String {
        ...
        case .fiveStars:
            return "You're building momentum! The more youfocus on regular practice, the better you get at choosing to keep up your intentioned habits."
        case .shutterbug:
            return "Photos connect us to our past, and looking at them can take us right back to the greatful feelings we had when we snapped them."
        case .expressive:
            return "Look at you, giving yourself all the ways to savor your happy memories!"
        case .perfectTen:
            return "You're getting the hang of your new habit! Keep it up and see hwo far it can take you."
        }
    }
